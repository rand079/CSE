...
public class RandomClassDriftStream extends AbstractOptionHandler implements InstanceStream {
	...
	public Example<Instance> nextInstance() {
		...
		if(rng.nextDouble() < driftChance){
			...
			for(int a = 0; a < numAtts; a++){
				attScale[(int)thisClass][a] = rng.nextDouble() - 0.5;
				attTranslate[(int)thisClass][a] = rng.nextDouble() - 0.5;
				if(nominalVars.contains(a)) adjNominals[(int)thisClass][a] = rng.nextInt(numNominalValues[a]);
			}
		}
